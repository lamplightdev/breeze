...
var Tokenizer = function () {
  ...
  Tokenizer.prototype.stateAfterCdata1 = function (c) {
    if (c === "]")
    this._state = 31 /* AfterCdata2 */;else
  ...
  Tokenizer.prototype.stateBeforeSpecialSEnd = function (c) {
    ...
    if (this.special === 3 /* Style */ && (c === "t" || c === "T")) {
  ...
  Tokenizer.prototype.stateInNamedEntity = function (c) {
    ...
    if ((c < "0" || c > "9") && !isASCIIAlpha(c)) {
      if (this.xmlMode || this.sectionStart + 1 === this._index) ;else
      if (this.baseState !== 1 /* Text */) {
        if (c !== "=") {
  ...
  Tokenizer.prototype.parse = function () {
    while (this._index < this.buffer.length && this.running) {
      ...
      if (this._state === 12 /* InAttributeValueDq */) {
        this.stateInAttributeValueDoubleQuotes(c);
      } else
      if (this._state === 9 /* InAttributeName */) {
        this.stateInAttributeName(c);
      } else
      if (this._state === 19 /* InComment */) {
        this.stateInComment(c);
      } else
      if (this._state === 20 /* InSpecialComment */) {
        this.stateInSpecialComment(c);
      } else
      if (this._state === 8 /* BeforeAttributeName */) {
        this.stateBeforeAttributeName(c);
      } else
      if (this._state === 3 /* InTagName */) {
        this.stateInTagName(c);
      } else
      if (this._state === 6 /* InClosingTagName */) {
        this.stateInClosingTagName(c);
      } else
      if (this._state === 2 /* BeforeTagName */) {
        this.stateBeforeTagName(c);
      } else
      if (this._state === 10 /* AfterAttributeName */) {
        this.stateAfterAttributeName(c);
      } else
      if (this._state === 13 /* InAttributeValueSq */) {
        this.stateInAttributeValueSingleQuotes(c);
      } else
      if (this._state === 11 /* BeforeAttributeValue */) {
        this.stateBeforeAttributeValue(c);
      } else
      if (this._state === 5 /* BeforeClosingTagName */) {
        this.stateBeforeClosingTagName(c);
      } else
      if (this._state === 7 /* AfterClosingTagName */) {
        this.stateAfterClosingTagName(c);
      } else
      if (this._state === 32 /* BeforeSpecialS */) {
        this.stateBeforeSpecialS(c);
      } else
      if (this._state === 21 /* AfterComment1 */) {
        this.stateAfterComment1(c);
      } else
      if (this._state === 14 /* InAttributeValueNq */) {
        this.stateInAttributeValueNoQuotes(c);
      } else
      if (this._state === 4 /* InSelfClosingTag */) {
        this.stateInSelfClosingTag(c);
      } else
      if (this._state === 16 /* InDeclaration */) {
        this.stateInDeclaration(c);
      } else
      if (this._state === 15 /* BeforeDeclaration */) {
        this.stateBeforeDeclaration(c);
      } else
      if (this._state === 22 /* AfterComment2 */) {
        this.stateAfterComment2(c);
      } else
      if (this._state === 18 /* BeforeComment */) {
        this.stateBeforeComment(c);
      } else
      if (this._state === 33 /* BeforeSpecialSEnd */) {
        this.stateBeforeSpecialSEnd(c);
      } else
      if (this._state === 53 /* BeforeSpecialTEnd */) {
        stateAfterSpecialTEnd(this, c);
      } else
      if (this._state === 39 /* AfterScript1 */) {
        stateAfterScript1(this, c);
      } else
      if (this._state === 40 /* AfterScript2 */) {
        stateAfterScript2(this, c);
      } else
      if (this._state === 41 /* AfterScript3 */) {
        stateAfterScript3(this, c);
      } else
      if (this._state === 34 /* BeforeScript1 */) {
        stateBeforeScript1(this, c);
      } else
      if (this._state === 35 /* BeforeScript2 */) {
        stateBeforeScript2(this, c);
      } else
      if (this._state === 36 /* BeforeScript3 */) {
        stateBeforeScript3(this, c);
      } else
      if (this._state === 37 /* BeforeScript4 */) {
        stateBeforeScript4(this, c);
      } else
      if (this._state === 38 /* BeforeScript5 */) {
        this.stateBeforeSpecialLast(c, 2 /* Script */);
      } else
      if (this._state === 42 /* AfterScript4 */) {
        stateAfterScript4(this, c);
      } else
      if (this._state === 43 /* AfterScript5 */) {
        this.stateAfterSpecialLast(c, 6);
      } else
      if (this._state === 44 /* BeforeStyle1 */) {
        stateBeforeStyle1(this, c);
      } else
      if (this._state === 29 /* InCdata */) {
        this.stateInCdata(c);
      } else
      if (this._state === 45 /* BeforeStyle2 */) {
        stateBeforeStyle2(this, c);
      } else
      if (this._state === 46 /* BeforeStyle3 */) {
        stateBeforeStyle3(this, c);
      } else
      if (this._state === 47 /* BeforeStyle4 */) {
        this.stateBeforeSpecialLast(c, 3 /* Style */);
      } else
      if (this._state === 48 /* AfterStyle1 */) {
        stateAfterStyle1(this, c);
      } else
      if (this._state === 49 /* AfterStyle2 */) {
        stateAfterStyle2(this, c);
      } else
      if (this._state === 50 /* AfterStyle3 */) {
        stateAfterStyle3(this, c);
      } else
      if (this._state === 51 /* AfterStyle4 */) {
        this.stateAfterSpecialLast(c, 5);
      } else
      if (this._state === 52 /* BeforeSpecialT */) {
        stateBeforeSpecialT(this, c);
      } else
      if (this._state === 54 /* BeforeTitle1 */) {
        stateBeforeTitle1(this, c);
      } else
      if (this._state === 55 /* BeforeTitle2 */) {
        stateBeforeTitle2(this, c);
      } else
      if (this._state === 56 /* BeforeTitle3 */) {
        stateBeforeTitle3(this, c);
      } else
      if (this._state === 57 /* BeforeTitle4 */) {
        this.stateBeforeSpecialLast(c, 4 /* Title */);
      } else
      if (this._state === 58 /* AfterTitle1 */) {
        stateAfterTitle1(this, c);
      } else
      if (this._state === 59 /* AfterTitle2 */) {
        stateAfterTitle2(this, c);
      } else
      if (this._state === 60 /* AfterTitle3 */) {
        stateAfterTitle3(this, c);
      } else
      if (this._state === 61 /* AfterTitle4 */) {
        this.stateAfterSpecialLast(c, 5);
      } else
      if (this._state === 17 /* InProcessingInstruction */) {
        this.stateInProcessingInstruction(c);
      } else
      if (this._state === 64 /* InNamedEntity */) {
        this.stateInNamedEntity(c);
      } else
      if (this._state === 23 /* BeforeCdata1 */) {
        stateBeforeCdata1(this, c);
      } else
      if (this._state === 62 /* BeforeEntity */) {
        stateBeforeEntity(this, c);
      } else
      if (this._state === 24 /* BeforeCdata2 */) {
        stateBeforeCdata2(this, c);
      } else
      if (this._state === 25 /* BeforeCdata3 */) {
        stateBeforeCdata3(this, c);
      } else
      if (this._state === 30 /* AfterCdata1 */) {
        this.stateAfterCdata1(c);
      } else
      if (this._state === 31 /* AfterCdata2 */) {
        this.stateAfterCdata2(c);
      } else
      if (this._state === 26 /* BeforeCdata4 */) {
        stateBeforeCdata4(this, c);
      } else
      if (this._state === 27 /* BeforeCdata5 */) {
        stateBeforeCdata5(this, c);
      } else
      if (this._state === 28 /* BeforeCdata6 */) {
        this.stateBeforeCdata6(c);
      } else
      if (this._state === 66 /* InHexEntity */) {
        this.stateInHexEntity(c);
      } else
      if (this._state === 65 /* InNumericEntity */) {
        this.stateInNumericEntity(c);
        // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
      } else
      if (this._state === 63 /* BeforeNumericEntity */) {
  ...
  Tokenizer.prototype.handleTrailingData = function () {
    ...
    if (this._state === 64 /* InNamedEntity */ && !this.xmlMode) {
      this.parseLegacyEntity();
      if (this.sectionStart < this._index) {
        this._state = this.baseState;
        this.handleTrailingData();
    ...
    if (this._state === 65 /* InNumericEntity */ && !this.xmlMode) {
      this.decodeNumericEntity(2, 10, false);
      if (this.sectionStart < this._index) {
        this._state = this.baseState;
        this.handleTrailingData();
    ...
    if (this._state === 66 /* InHexEntity */ && !this.xmlMode) {
      this.decodeNumericEntity(3, 16, false);
      if (this.sectionStart < this._index) {
        this._state = this.baseState;
        this.handleTrailingData();
...
var Parser$1 = function () {
  ...
  Parser.prototype.onopentagname = function (name) {
    ...
    if (this.options.xmlMode || !voidElements$1.has(name)) {
      ...
      if (htmlIntegrationElements.has(name)) {
  ...
  Parser.prototype.onclosetag = function (name) {
    ...
    this.options.xmlMode || !voidElements$1.has(name))) {
      ...
      if (name === "p" && !this.options.xmlMode) {
        this.onopentagname(name);
        this.closeCurrentTag();
      }
    } else
    if (!this.options.xmlMode && (name === "br" || name === "p")) {
      this.onopentagname(name);
      this.closeCurrentTag();
    }
  };
...
var Document$2 = function (_super) {
...
const createTrigger = (method, isConnected) => (element) => {
  if (customElements$1.has(element)) {
    const info = customElements$1.get(element);
...
class CustomElementRegistry {
  ...
  upgrade(element) {
    ...
    if (registry.has(ce)) {
      ...
      if (check(element)) {
        ...
        customElements$1.set(element, { connected: isConnected });
  ...
  whenDefined(localName) {
    ...
    return new Promise((resolve) => {
      if (registry.has(localName))
      resolve(registry.get(localName).Class);else
      {
        if (!waiting.has(localName))
...
const booleanAttribute = {
  ...
  set(element, name, value) {
    if (value)
    element.setAttribute(name, '');else
...
try {
  ...
  (function (Object, wm) {
    ...
    function dispatch(info) {
      ...
      info.listener.call(info.target, this);else
  ...
  compareDocumentPosition(target) {
    ...
    if (this !== target) {
      ...
      if (self && other) {
        ...
        result += DOCUMENT_POSITION_FOLLOWING;else
 ...
 *  converted as string.
 */
const escape = (es) => replace$1.call(es, ca$1, pe$1);
    ...
    } else
    {
      ...
      if (firstChar === "[") {
        ...
        if (action !== "exists") {
          ...
          if (forceIgnore === "i" || forceIgnore === "I") {
            ignoreCase = true;
            stripWhitespace(1);
          }
        }
...
function getProcedure(token) {
  ...
  if (token.type === "pseudo") {
    ...
    if (token.name === "has" || token.name === "contains") {
...
function absolutize(token, _a, context) {
  ...
  for (var _i = 0, token_1 = token; _i < token_1.length; _i++) {
    var t = token_1[_i];
    if (t.length > 0 && procedure_1.isTraversal(t[0]) && t[0].type !== "descendant") ;else
...
function compileToken(token, options, context) {
  ...
  map(function (rules) {
    if (rules.length >= 2) {
      ...
      if (first.type !== "pseudo" || first.name !== "scope") ;else
      if (isArrayContext && second.type === "descendant") {
        rules[1] = FLEXIBLE_DESCENDANT_TOKEN;
      } else
      if (second.type === "adjacent" ||
      second.type === "sibling") {
...
class Text$1 extends CharacterData$1 {
  ...
  get wholeText() {
    ...
    while (previousSibling) {
      ...
      text.unshift(previousSibling[VALUE]);else
    ...
    while (nextSibling) {
      ...
      text.push(nextSibling[VALUE]);else
...
const handler$1 = {
  ...
  set(style, name, value) {
    if (name === 'cssText')
    style[name] = value;else
    {
      let attr = updateKeys(style);
      if (value == null)
      style.delete(uhyphen(name));else
      ...
      switch (next.nodeType) {
        ...
        case NODE_END:{
            ...
            if (isOpened) {
              ...
              out.push(' />');else
              if (isVoid(start))
              out.push(ignoreCase(start) ? '>' : ' />');else
 ...
 */
class HTMLTemplateElement$1 extends HTMLElement$1 {
  constructor(ownerDocument) {
...
registerHTMLClass(tagName$d, HTMLTemplateElement$1);
...
//.CommonJS
CSSStyleSheet$1.CSSStyleSheet = CSSOM$g.CSSStyleSheet;
...
var CSSOM$e = {
  CSSRule: CSSRule.CSSRule,
  CSSStyleSheet: CSSStyleSheet$1.CSSStyleSheet,
...
CSSOM$1.CSSStyleSheet = CSSStyleSheet$1.CSSStyleSheet;
...
class HTMLSelectElement extends HTMLElement$1 {
  ...
  get options() {
    ...
    while (firstElementChild) {
      ...
      children.push(...firstElementChild.children);else
...
const voidElements$2 = { test: () => true };
const Mime = {
  'text/html': {
...
const deleteContents = ({ [START]: start, [END]: end }, fragment = null) => {
  ...
  do {
    ...
    if (fragment)
    fragment.insertBefore(start, fragment[END]);else
...
const createHTMLElement$1 = (ownerDocument, builtin, localName, options) => {
  ...
  if (active) {
    ...
    if (registry.has(ce)) {
      ...
      customElements$1.set(element, { connected: false });
      return element;
    }
  }
...
class HTMLDocument extends Document$1 {
  ...
  set title(textContent) {
    ...
    let title = head.getElementsByTagName('title').shift();
    if (title)
    title.textContent = textContent;else
    {
      head.insertBefore(
...
setPrototypeOf(Document$3, Document$1).prototype = Document$1.prototype;
...
function Shim (shimedGlobals = Object.freeze([]), global = false) {
  ...
  "node_modules/parse5/lib/tokenizer/index.js"(exports, module) {
    ...
    var Tokenizer = class {
      ...
      _isTempBufferEqualToScriptString() {
        ...
        for (let i7 = 0; i7 < this.tempBuff.length; i7++) {
          if (this.tempBuff[i7] !== $$.SCRIPT_STRING[i7]) {
            return false;
          }
        }
        return true;
      ...
      _emitSeveralCodePoints(codePoints) {
        for (let i7 = 0; i7 < codePoints.length; i7++) {
          this._emitCodePoint(codePoints[i7]);
        }
      }
      _emitChars(ch) {
      ...
      _matchNamedCharacterReference(startCp) {
        let result = null;
        let excess = 1;
        let i7 = findNamedEntityTreeBranch(0, startCp);
        this.tempBuff.push(startCp);
        while (i7 > -1) {
          const current = neTree[i7];
          const inNode = current < MAX_BRANCH_MARKER_VALUE;
          const nodeWithData = inNode && current & HAS_DATA_FLAG;
          if (nodeWithData) {
            result = current & DATA_DUPLET_FLAG ? [neTree[++i7], neTree[++i7]] : [neTree[++i7]];
            excess = 0;
          }
          const cp = this._consume();
          ...
          if (inNode) {
            i7 = current & HAS_BRANCHES_FLAG ? findNamedEntityTreeBranch(i7, cp) : -1;
          } else {
            i7 = cp === current ? ++i7 : -1;
          }
        }
      ...
      _flushCodePointsConsumedAsCharacterReference() {
        if (this._isCharacterReferenceInAttribute()) {
          for (let i7 = 0; i7 < this.tempBuff.length; i7++) {
            this.currentAttr.value += toChar(this.tempBuff[i7]);
          }
        } else {
    ...
    Tokenizer.getTokenAttr = function (token, attrName) {
      for (let i7 = token.attrs.length - 1; i7 >= 0; i7--) {
        if (token.attrs[i7].name === attrName) {
          return token.attrs[i7].value;
        }
      }
      return null;
    };
...
var require_open_element_stack = __commonJS({
  "node_modules/parse5/lib/parser/open-element-stack.js"(exports, module) {
    ...
    var OpenElementStack = class {
      ...
      _indexOf(element) {
        let idx = -1;
        for (let i7 = this.stackTop; i7 >= 0; i7--) {
          if (this.items[i7] === element) {
            idx = i7;
            break;
          }
        }
      ...
      hasInScope(tagName) {
        for (let i7 = this.stackTop; i7 >= 0; i7--) {
          const tn = this.treeAdapter.getTagName(this.items[i7]);
          const ns = this.treeAdapter.getNamespaceURI(this.items[i7]);
          if (tn === tagName && ns === NS.HTML) {
            return true;
          }
    ...
    var FormattingElementList = class {
      ...
      _getNoahArkConditionCandidates(newElement) {
        ...
        if (this.length >= NOAH_ARK_CAPACITY) {
          ...
          for (let i7 = this.length - 1; i7 >= 0; i7--) {
            const entry = this.entries[i7];
            ...
            if (isCandidate) {
              candidates.push({ idx: i7, attrs: elementAttrs });
            }
          }
        }
      ...
      _ensureNoahArkCondition(newElement) {
        ...
        if (cLength) {
          ...
          for (let i7 = 0; i7 < neAttrsLength; i7++) {
            const neAttr = neAttrs[i7];
            neAttrsMap[neAttr.name] = neAttr.value;
          }
          for (let i7 = 0; i7 < neAttrsLength; i7++) {
            for (let j = 0; j < cLength; j++) {
              const cAttr = candidates[j].attrs[i7];
          ...
          for (let i7 = cLength - 1; i7 >= NOAH_ARK_CAPACITY - 1; i7--) {
            this.entries.splice(candidates[i7].idx, 1);
            this.length--;
          }
        }
      }
      ...
      removeEntry(entry) {
        for (let i7 = this.length - 1; i7 >= 0; i7--) {
          if (this.entries[i7] === entry) {
            this.entries.splice(i7, 1);
            this.length--;
            break;
          }
        }
...
var require_mixin = __commonJS({
  "node_modules/parse5/lib/utils/mixin.js"(exports, module) {
    ...
    Mixin.install = function (host, Ctor, opts) {
      ...
      for (let i7 = 0; i7 < host.__mixins.length; i7++) {
        if (host.__mixins[i7].constructor === Ctor) {
          return host.__mixins[i7];
        }
      }
      ...
      _getOverriddenMethods(mxn, orig) {
        return {
          ...
          _runParsingLoop(scriptHandler) {
            ...
            for (let i7 = this.openElements.stackTop; i7 >= 0; i7--) {
              mxn._setEndLocation(this.openElements.items[i7], mxn.currentToken);
            }
          },
          ...
          _processToken(token) {
            ...
            if (requireExplicitUpdate) {
              for (let i7 = this.openElements.stackTop; i7 >= 0; i7--) {
                const element = this.openElements.items[i7];
          ...
          _setDocumentType(token) {
            ...
            for (let i7 = 0; i7 < cnLength; i7++) {
              const node = documentChildren[i7];
...
var require_default = __commonJS({
  "node_modules/parse5/lib/tree-adapters/default.js"(exports) {
    ...
    exports.setDocumentType = function (document2, name, publicId, systemId) {
      ...
      for (let i7 = 0; i7 < document2.childNodes.length; i7++) {
        if (document2.childNodes[i7].nodeName === "#documentType") {
          doctypeNode = document2.childNodes[i7];
          break;
        }
      }
      if (doctypeNode) {
    ...
    exports.adoptAttributes = function (recipient, attrs) {
      ...
      for (let i7 = 0; i7 < recipient.attrs.length; i7++) {
        recipientAttrsMap.push(recipient.attrs[i7].name);
      }
...
var require_doctype = __commonJS({
  "node_modules/parse5/lib/common/doctype.js"(exports) {
    ...
    function hasPrefix(publicId, prefixes) {
      for (let i7 = 0; i7 < prefixes.length; i7++) {
        if (publicId.indexOf(prefixes[i7]) === 0) {
          return true;
        }
      }
      return false;
...
var require_foreign_content = __commonJS({
  "node_modules/parse5/lib/common/foreign-content.js"(exports) {
    ...
    exports.adjustTokenMathMLAttrs = function (token) {
      for (let i7 = 0; i7 < token.attrs.length; i7++) {
        if (token.attrs[i7].name === DEFINITION_URL_ATTR) {
          token.attrs[i7].name = ADJUSTED_DEFINITION_URL_ATTR;
          break;
        }
      }
    };
    exports.adjustTokenSVGAttrs = function (token) {
      for (let i7 = 0; i7 < token.attrs.length; i7++) {
        const adjustedAttrName = SVG_ATTRS_ADJUSTMENT_MAP[token.attrs[i7].name];
        if (adjustedAttrName) {
          token.attrs[i7].name = adjustedAttrName;
        }
      }
    };
    exports.adjustTokenXMLAttrs = function (token) {
      for (let i7 = 0; i7 < token.attrs.length; i7++) {
        const adjustedAttrEntry = XML_ATTRS_ADJUSTMENT_MAP[token.attrs[i7].name];
        if (adjustedAttrEntry) {
          token.attrs[i7].prefix = adjustedAttrEntry.prefix;
          token.attrs[i7].name = adjustedAttrEntry.name;
          token.attrs[i7].namespace = adjustedAttrEntry.namespace;
        }
      }
    };
    ...
    function isHtmlIntegrationPoint(tn, ns, attrs) {
      if (ns === NS.MATHML && tn === $2.ANNOTATION_XML) {
        for (let i7 = 0; i7 < attrs.length; i7++) {
          if (attrs[i7].name === ATTRS.ENCODING) {
            const value = attrs[i7].value.toLowerCase();
...
var require_parser = __commonJS({
  "node_modules/parse5/lib/parser/index.js"(exports, module) {
    ...
    var Parser = class {
      ...
      _reconstructActiveFormattingElements() {
        ...
        if (listLength) {
          ...
          for (let i7 = unopenIdx; i7 < listLength; i7++) {
            entry = this.activeFormattingElements.entries[i7];
      ...
      _resetInsertionMode() {
        for (let i7 = this.openElements.stackTop, last = false; i7 >= 0; i7--) {
          let element = this.openElements.items[i7];
          if (i7 === 0) {
            last = true;
          ...
          if (newInsertionMode) {
            ...
            this._resetInsertionModeForSelect(i7);
            break;
      ...
      _resetInsertionModeForSelect(selectIdx) {
        if (selectIdx > 0) {
          for (let i7 = selectIdx - 1; i7 > 0; i7--) {
            const ancestor = this.openElements.items[i7];
      ...
      _findFosterParentingLocation() {
        ...
        for (let i7 = this.openElements.stackTop; i7 >= 0; i7--) {
          const openElement = this.openElements.items[i7];
          ...
          if (tn === $2.TEMPLATE && ns === NS.HTML) {
            ...
            if (location.parent) {
              ...
              location.parent = this.openElements.items[i7 - 1];
            }
            break;
          }
        }
    ...
    function aaObtainFurthestBlock(p2, formattingElementEntry) {
      ...
      for (let i7 = p2.openElements.stackTop; i7 >= 0; i7--) {
        const element = p2.openElements.items[i7];
    ...
    function aaInnerLoop(p2, furthestBlock, formattingElement) {
      ...
      for (let i7 = 0, element = nextElement; element !== formattingElement; i7++, element = nextElement) {
        ...
        const counterOverflow = elementEntry && i7 >= AA_INNER_LOOP_ITER;
    ...
    function callAdoptionAgency(p2, token) {
      ...
      for (let i7 = 0; i7 < AA_OUTER_LOOP_ITER; i7++) {
    ...
    function tokenInTableText(p2, token) {
      ...
      if (p2.hasNonWhitespacePendingCharacterToken) {
        for (; i7 < p2.pendingCharacterTokens.length; i7++) {
          tokenInTable(p2, p2.pendingCharacterTokens[i7]);
        }
      } else {
        for (; i7 < p2.pendingCharacterTokens.length; i7++) {
          p2._insertCharacters(p2.pendingCharacterTokens[i7]);
        }
      }
      p2.insertionMode = p2.originalInsertionMode;
      p2._processToken(token);
  ...
  "node_modules/parse5/lib/serializer/index.js"(exports, module) {
    ...
    var Serializer = class {
      ...
      _serializeChildNodes(parentNode) {
        ...
        if (childNodes) {
          for (let i7 = 0, cnLength = childNodes.length; i7 < cnLength; i7++) {
            const currentNode = childNodes[i7];
      ...
      _serializeAttributes(node) {
        ...
        for (let i7 = 0, attrsLength = attrs.length; i7 < attrsLength; i7++) {
          const attr = attrs[i7];
...
var require_lib = __commonJS({
  "node_modules/parse5/lib/index.js"(exports) {
    ...
    exports.parseFragment = function parseFragment3(fragmentContext, html, options) {
...
// package/lib/element-renderer.js
var import_escape_html = __toModule(require_escape_html());
var getElementRenderer = ({ elementRenderers }, tagName, ceClass = customElements.get(tagName), attributes = new Map()) => {
  if (ceClass === void 0) {
...
var ElementRenderer = class {
  ...
  *renderAttributes() {
    if (this.element !== void 0) {
      ...
      for (let i7 = 0, name, value; i7 < attributes.length && ({ name, value } = attributes[i7]); i7++) {
        if (value === "") {
          yield ` ${name}`;
        } else {
          yield ` ${name}="${(0, import_escape_html.default)(value)}"`;
        }
      }
    }
  }};
...
var S = (e5, s6) => {
  t ? e5.adoptedStyleSheets = s6.map((t4) => t4 instanceof CSSStyleSheet ? t4 : t4.styleSheet) : s6.forEach((t4) => {
    const s7 = document.createElement("style");
    s7.textContent = t4.cssText, e5.appendChild(s7);
  });
};
...
var a = class extends HTMLElement {
  ...
  static addInitializer(t4) {
    var i7;
    (i7 = this.v) !== null && i7 !== void 0 || (this.v = []), this.v.push(t4);
  }
  static get observedAttributes() {
    this.finalize();
    const t4 = [];
    return this.elementProperties.forEach((i7, s6) => {
      const e5 = this.Πp(s6, i7);
      e5 !== void 0 && (this.Πm.set(e5, s6), t4.push(e5));
    }), t4;
  }
  static createProperty(t4, i7 = l) {
    if (i7.state && (i7.attribute = false), this.finalize(), this.elementProperties.set(t4, i7), !i7.noAccessor && !this.prototype.hasOwnProperty(t4)) {
      const s6 = typeof t4 == "symbol" ? Symbol() : "__" + t4,e5 = this.getPropertyDescriptor(t4, s6, i7);
  ...
  static getPropertyDescriptor(t4, i7, s6) {
    return { get() {
        ...
        const h4 = this[t4];
        this[i7] = e5, this.requestUpdate(t4, h4, s6);
  ...
  addController(t4) {
    var i7, s6;
    ((i7 = this.ΠU) !== null && i7 !== void 0 ? i7 : this.ΠU = []).push(t4), this.renderRoot !== void 0 && this.isConnected && ((s6 = t4.hostConnected) === null || s6 === void 0 || s6.call(t4));
  }
  removeController(t4) {
    var i7;
    (i7 = this.ΠU) === null || i7 === void 0 || i7.splice(this.ΠU.indexOf(t4) >>> 0, 1);
  }
  Π_() {
  ...
  Πj(t4, i7, s6 = l) {
    var e5, h4;
    const r6 = this.constructor.Πp(t4, s6);
    if (r6 !== void 0 && s6.reflect === true) {
      const n6 = ((h4 = (e5 = s6.converter) === null || e5 === void 0 ? void 0 : e5.toAttribute) !== null && h4 !== void 0 ? h4 : o2.toAttribute)(i7, s6.type);
      this.Πh = t4, n6 == null ? this.removeAttribute(r6) : this.setAttribute(r6, n6), this.Πh = null;
    }
  }
  K(t4, i7) {
    var s6, e5, h4;
    const r6 = this.constructor,n6 = r6.Πm.get(t4);
    if (n6 !== void 0 && this.Πh !== n6) {
      const t5 = r6.getPropertyOptions(n6),l4 = t5.converter,a4 = (h4 = (e5 = (s6 = l4) === null || s6 === void 0 ? void 0 : s6.fromAttribute) !== null && e5 !== void 0 ? e5 : typeof l4 == "function" ? l4 : null) !== null && h4 !== void 0 ? h4 : o2.fromAttribute;
      this.Πh = n6, this[n6] = a4(i7, t5.type), this.Πh = null;
    }
  }
  requestUpdate(t4, i7, s6) {
    let e5 = true;
    t4 !== void 0 && (((s6 = s6 || this.constructor.getPropertyOptions(t4)).hasChanged || n2)(this[t4], i7) ? (this.L.has(t4) || this.L.set(t4, i7), s6.reflect === true && this.Πh !== t4 && (this.Πk === void 0 && (this.Πk = new Map()), this.Πk.set(t4, s6))) : e5 = false), !this.isUpdatePending && e5 && (this.Πg = this.Πq());
  }
  async Πq() {
  ...
  performUpdate() {
    ...
    return;
    this.hasUpdated, this.Πi && (this.Πi.forEach((t5, i8) => this[i8] = t5), this.Πi = void 0);
    let i7 = false;
    const s6 = this.L;
    try {
      i7 = this.shouldUpdate(s6), i7 ? (this.willUpdate(s6), (t4 = this.ΠU) === null || t4 === void 0 || t4.forEach((t5) => {
        var i8;
        return (i8 = t5.hostUpdate) === null || i8 === void 0 ? void 0 : i8.call(t5);
      }), this.update(s6)) : this.Π$();
    } catch (t5) {
      throw i7 = false, this.Π$(), t5;
    }
    i7 && this.E(s6);
  }
  willUpdate(t4) {
  ...
  E(t4) {
    var i7;
    (i7 = this.ΠU) === null || i7 === void 0 || i7.forEach((t5) => {
      var i8;
  ...
  update(t4) {
    this.Πk !== void 0 && (this.Πk.forEach((t5, i7) => this.Πj(i7, this[i7], t5)), this.Πk = void 0), this.Π$();
  }
  updated(t4) {
  }
  firstUpdated(t4) {
...
var a2 = (t4) => {
  var i7;
  return v(t4) || typeof ((i7 = t4) === null || i7 === void 0 ? void 0 : i7[Symbol.iterator]) == "function";
};
...
var V = (t4, i7, s6) => {
  var e5, o6;
  const l4 = (e5 = s6 == null ? void 0 : s6.renderBefore) !== null && e5 !== void 0 ? e5 : i7;
  let n6 = l4._$litPart$;
  if (n6 === void 0) {
    const t5 = (o6 = s6 == null ? void 0 : s6.renderBefore) !== null && o6 !== void 0 ? o6 : null;
    l4._$litPart$ = n6 = new C(i7.insertBefore(c(), t5), t5, void 0, s6);
  }
  return n6.I(t4), n6;
};
...
var M = (t4, i7) => {
  ...
  let o6,h4 = i7 === 2 ? "<svg>" : "",u4 = f;
  for (let i8 = 0; i8 < s6; i8++) {
    const s7 = t4[i8];
    let l4,c3,d3 = -1,v3 = 0;
    for (; v3 < s7.length && (u4.lastIndex = v3, c3 = u4.exec(s7), c3 !== null);)
    v3 = u4.lastIndex, u4 === f ? c3[1] === "!--" ? u4 = _ : c3[1] !== void 0 ? u4 = m : c3[2] !== void 0 ? (y.test(c3[2]) && (o6 = RegExp("</" + c3[2], "g")), u4 = p) : c3[3] !== void 0 && (u4 = p) : u4 === p ? c3[0] === ">" ? (u4 = o6 != null ? o6 : f, d3 = -1) : c3[1] === void 0 ? d3 = -2 : (d3 = u4.lastIndex - c3[2].length, l4 = c3[1], u4 = c3[3] === void 0 ? p : c3[3] === '"' ? g : $) : u4 === g || u4 === $ ? u4 = p : u4 === _ || u4 === m ? u4 = f : (u4 = p, o6 = void 0);
    const a4 = u4 === p && t4[i8 + 1].startsWith("/>") ? " " : "";
    h4 += u4 === f ? s7 + r3 : d3 >= 0 ? (e5.push(l4), s7.slice(0, d3) + "$lit$" + s7.slice(d3) + n3 + a4) : s7 + n3 + (d3 === -2 ? (e5.push(void 0), i8) : a4);
  }
  const c2 = h4 + (t4[s6] || "<?>") + (i7 === 2 ? "</svg>" : "");
  return [l2 !== void 0 ? l2.createHTML(c2) : c2, e5];
};
var N = class {
  constructor({ strings: t4, _$litType$: i7 }, s6) {
    let e5;
    this.parts = [];
    let l4 = 0,r6 = 0;
    const u4 = t4.length - 1,d3 = this.parts,[v3, a4] = M(t4, i7);
    if (this.el = N.createElement(v3, s6), E.currentNode = this.el.content, i7 === 2) {
      const t5 = this.el.content,i8 = t5.firstChild;
      i8.remove(), t5.append(...i8.childNodes);
    }
    for (; (e5 = E.nextNode()) !== null && d3.length < u4;) {
      if (e5.nodeType === 1) {
        if (e5.hasAttributes()) {
          const t5 = [];
          for (const i8 of e5.getAttributeNames())
          if (i8.endsWith("$lit$") || i8.startsWith(n3)) {
            const s7 = a4[r6++];
            if (t5.push(i8), s7 !== void 0) {
              const t6 = e5.getAttribute(s7.toLowerCase() + "$lit$").split(n3),i9 = /([.?@])?(.*)/.exec(s7);
              d3.push({ type: 1, index: l4, name: i9[2], strings: t6, ctor: i9[1] === "." ? I : i9[1] === "?" ? L : i9[1] === "@" ? R : H });
            } else
            d3.push({ type: 6, index: l4 });
          }
          for (const i8 of t5)
          e5.removeAttribute(i8);
        }
        if (y.test(e5.tagName)) {
          const t5 = e5.textContent.split(n3),i8 = t5.length - 1;
          if (i8 > 0) {
            e5.textContent = o3 ? o3.emptyScript : "";
            for (let s7 = 0; s7 < i8; s7++)
            e5.append(t5[s7], c()), E.nextNode(), d3.push({ type: 2, index: ++l4 });
            e5.append(t5[i8], c());
          }
        }
      } else if (e5.nodeType === 8)
      if (e5.data === h2)
      d3.push({ type: 2, index: l4 });else
      {
        let t5 = -1;
        for (; (t5 = e5.data.indexOf(n3, t5 + 1)) !== -1;)
        d3.push({ type: 7, index: l4 }), t5 += n3.length - 1;
      }
      l4++;
    }
  }
...
function S2(t4, i7, s6 = t4, e5) {
  ...
  if (i7 === w)
  return i7;
  let r6 = e5 !== void 0 ? (o6 = s6.Σi) === null || o6 === void 0 ? void 0 : o6[e5] : s6.Σo;
  const u4 = d(i7) ? void 0 : i7._$litDirective$;
  return (r6 == null ? void 0 : r6.constructor) !== u4 && ((l4 = r6 == null ? void 0 : r6.O) === null || l4 === void 0 || l4.call(r6, false), u4 === void 0 ? r6 = void 0 : (r6 = new u4(t4), r6.T(t4, s6, e5)), e5 !== void 0 ? ((n6 = (h4 = s6).Σi) !== null && n6 !== void 0 ? n6 : h4.Σi = [])[e5] = r6 : s6.Σo = r6), r6 !== void 0 && (i7 = S2(t4, r6.S(t4, i7.values), r6, e5)), i7;
}
var k = class {
  constructor(t4, i7) {
    this.l = [], this.N = void 0, this.D = t4, this.M = i7;
  }
  u(t4) {
    var i7;
    const { el: { content: s6 }, parts: e5 } = this.D,o6 = ((i7 = t4 == null ? void 0 : t4.creationScope) !== null && i7 !== void 0 ? i7 : u2).importNode(s6, true);
    E.currentNode = o6;
    let l4 = E.nextNode(),n6 = 0,h4 = 0,r6 = e5[0];
    for (; r6 !== void 0;) {
      if (n6 === r6.index) {
        let i8;
        r6.type === 2 ? i8 = new C(l4, l4.nextSibling, this, t4) : r6.type === 1 ? i8 = new r6.ctor(l4, r6.name, r6.strings, this, t4) : r6.type === 6 && (i8 = new z(l4, this, t4)), this.l.push(i8), r6 = e5[++h4];
      }
      n6 !== (r6 == null ? void 0 : r6.index) && (l4 = E.nextNode(), n6++);
    }
    return o6;
  }
  v(t4) {
    ...
    s6 !== void 0 && (s6.strings !== void 0 ? (s6.I(t4, s6, i7), i7 += s6.strings.length - 2) : s6.I(t4[i7])), i7++;
  }};

var C = class {
  constructor(t4, i7, s6, e5) {
    this.type = 2, this.N = void 0, this.A = t4, this.B = i7, this.M = s6, this.options = e5;
  }
  setConnected(t4) {
    var i7;
    (i7 = this.P) === null || i7 === void 0 || i7.call(this, t4);
  }
  get parentNode() {
  ...
  I(t4, i7 = this) {
    t4 = S2(this, t4, i7), d(t4) ? t4 === A || t4 == null || t4 === "" ? (this.H !== A && this.R(), this.H = A) : t4 !== this.H && t4 !== w && this.m(t4) : t4._$litType$ !== void 0 ? this._(t4) : t4.nodeType !== void 0 ? this.$(t4) : a2(t4) ? this.g(t4) : this.m(t4);
  }
  k(t4, i7 = this.B) {
    return this.A.parentNode.insertBefore(t4, i7);
  }
  $(t4) {
  ...
  m(t4) {
    ...
    i7 !== null && i7.nodeType === 3 && (this.B === null ? i7.nextSibling === null : i7 === this.B.previousSibling) ? i7.data = t4 : this.$(u2.createTextNode(t4)), this.H = t4;
  }
  _(t4) {
    var i7;
    const { values: s6, _$litType$: e5 } = t4,o6 = typeof e5 == "number" ? this.C(t4) : (e5.el === void 0 && (e5.el = N.createElement(e5.h, this.options)), e5);
    if (((i7 = this.H) === null || i7 === void 0 ? void 0 : i7.D) === o6)
    this.H.v(s6);else
    {
      const t5 = new k(o6, this),i8 = t5.u(this.options);
      t5.v(s6), this.$(i8), this.H = t5;
    }
  }
  C(t4) {
    let i7 = P.get(t4.strings);
    return i7 === void 0 && P.set(t4.strings, i7 = new N(t4)), i7;
  }
  g(t4) {
    ...
    let s6,e5 = 0;
    for (const o6 of t4)
    e5 === i7.length ? i7.push(s6 = new C(this.k(c()), this.k(c()), this, this.options)) : s6 = i7[e5], s6.I(o6), e5++;
    e5 < i7.length && (this.R(s6 && s6.B.nextSibling, e5), i7.length = e5);
  }
  R(t4 = this.A.nextSibling, i7) {
    var s6;
    for ((s6 = this.P) === null || s6 === void 0 || s6.call(this, false, true, i7); t4 && t4 !== this.B;) {
...
var H = class {
  constructor(t4, i7, s6, e5, o6) {
    this.type = 1, this.H = A, this.N = void 0, this.V = void 0, this.element = t4, this.name = i7, this.M = e5, this.options = o6, s6.length > 2 || s6[0] !== "" || s6[1] !== "" ? (this.H = Array(s6.length - 1).fill(A), this.strings = s6) : this.H = A;
  }
  get tagName() {
  ...
  I(t4, i7 = this, s6, e5) {
    ...
    let l4 = false;
    if (o6 === void 0)
    t4 = S2(this, t4, i7, 0), l4 = !d(t4) || t4 !== this.H && t4 !== w, l4 && (this.H = t4);else
    {
      const e6 = t4;
      let n6, h4;
      for (t4 = o6[0], n6 = 0; n6 < o6.length - 1; n6++)
      h4 = S2(this, e6[s6 + n6], i7, n6), h4 === w && (h4 = this.H[n6]), l4 || (l4 = !d(h4) || h4 !== this.H[n6]), h4 === A ? t4 = A : t4 !== A && (t4 += (h4 != null ? h4 : "") + o6[n6 + 1]), this.H[n6] = h4;
    }
    l4 && !e5 && this.W(t4);
  }
  W(t4) {
...
var R = class extends H {
  ...
  I(t4, i7 = this) {
    var s6;
    if ((t4 = (s6 = S2(this, t4, i7, 0)) !== null && s6 !== void 0 ? s6 : A) === w)
    return;
  ...
  handleEvent(t4) {
    var i7, s6;
    typeof this.H == "function" ? this.H.call((s6 = (i7 = this.options) === null || i7 === void 0 ? void 0 : i7.host) !== null && s6 !== void 0 ? s6 : this.element, t4) : this.H.handleEvent(t4);
  }};

var z = class {
  constructor(t4, i7, s6) {
    this.element = t4, this.type = 6, this.N = void 0, this.V = void 0, this.M = i7, this.options = s6;
  }
  I(t4) {
    S2(this, t4);
  }};
...
var h3 = class extends a {
  ...
  createRenderRoot() {
    ...
    return (t4 = (e5 = this.renderOptions).renderBefore) !== null && t4 !== void 0 || (e5.renderBefore = r6.firstChild), r6;
  }
  update(t4) {
    const r6 = this.render();
    super.update(t4), this.Φt = V(r6, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t4;
...
var e4 = { attributeToProperty: u3.K, changedProperties: u3.L };
...
var s5 = class {
  ...
  T(t4, i7, s6) {
    this.Σdt = t4, this.M = i7, this.Σct = s6;
  }
  S(t4, i7) {
    return this.update(t4, i7);
  }
  update(t4, i7) {
...
var v2 = (o6, t4) => {
  var i7, n6;
  return t4 === void 0 ? ((i7 = o6) === null || i7 === void 0 ? void 0 : i7._$litType$) !== void 0 : ((n6 = o6) === null || n6 === void 0 ? void 0 : n6._$litType$) === t4;
};
var r4 = (o6) => {
  var t4;
  return (t4 = o6) === null || t4 === void 0 ? void 0 : t4._$litDirective$;
};

// node_modules/lit-html/private-ssr-support.js
var r5 = { boundAttributeSuffix: Z.Z, marker: Z.U, markerMatch: Z.Y, HTML_RESULT: Z.q, getTemplateHtml: Z.X, overrideDirectiveResolve: (t4, e5) => class extends t4 {
    S(t5, r6) {
      return e5(this, r6);
    }},
  getAttributePartCommittedValue: (t4, r6, a4) => {
    let i7 = w;
    return t4.W = (t5) => i7 = t5, t4.I(r6, t4, a4), i7;
  }, resolveDirective: Z.st, AttributePart: Z.ot, PropertyPart: Z.lt, BooleanAttributePart: Z.nt, EventPart: Z.rt, ElementPart: Z.ht };

// node_modules/lit-html/experimental-hydrate.js
var m2 = (e5) => {
  const t4 = new Uint32Array(2).fill(5381);
  for (const r6 of e5.strings)
  for (let e6 = 0; e6 < r6.length; e6++)
  t4[e6 % 2] = 33 * t4[e6 % 2] ^ r6.charCodeAt(e6);
  return btoa(String.fromCharCode(...new Uint8Array(t4.buffer)));
};

// package/lib/render-lit-html.js
var import_escape_html2 = __toModule(require_escape_html());

// package/lib/util/parse5-utils.js
var parse5 = __toModule(require_lib());
var parseFragment2 = parse5.parseFragment;
...
var defaultChildNodes = (node) => node.childNodes;
var traverse = (node, visitor, parent) => {
...
var i6 = class extends s5 {
  ...
  update(e5) {
    const r6 = e5.parentNode;
    if (typeof r6.renderLight == "function")
    return r6.renderLight();
  }};

i6.o = true;
var n5 = (e5) => {
  var r6;
  return (r6 = r4(e5)) === null || r6 === void 0 ? void 0 : r6.o;
};

// package/lib/reflected-attributes.js
...
["background", ["body"]],
[["bgcolor", "bgColor"], ["body", "marquee", "table", "td", "th", "tr"]],
...
["title", ["*"]],
["translate", []],
["type", ["button", "input", "embed", "object", "script", "source", "style"]],
...
// package/lib/render-lit-html.js
var { getTemplateHtml, marker, markerMatch, boundAttributeSuffix, overrideDirectiveResolve, getAttributePartCommittedValue, resolveDirective, AttributePart, PropertyPart, BooleanAttributePart, EventPart } = r5;
var patchedDirectiveCache = new Map();
...
var patchAnyDirectives = (part, value, valueIndex) => {
  if (part.strings !== void 0) {
    for (let i7 = 0; i7 < part.strings.length - 1; i7++) {
      patchIfDirective(value[valueIndex + i7]);
    }
  } else {
...
var getTemplateOpcodes = (result) => {
  const template = templateCache$1.get(result.strings);
  if (template !== void 0) {
    return template;
  }
  const [html, attrNames] = getTemplateHtml(result.strings, result._$litType$);
  const ast = parseFragment2(String(html), {
            ...
            if (isAttrBinding || isElementBinding) {
              ...
              if (isAttrBinding) {
                ...
                ops.push({
                  ...
                  useCustomElementInstance: ctor !== void 0 });
  ...
  flushTo();
  templateCache$1.set(result.strings, ops);
  return ops;
};
var defaultRenderInfo = {
...
function* renderValue(value, renderInfo) {
  ...
  if (n5(value)) {
    ...
    value = resolveDirective({ type: t3.CHILD }, value);
  }
  if (value != null && v2(value)) {
    yield `<!--lit-part ${m2(value)}-->`;
    yield* renderTemplateResult(value, renderInfo);
  } else {
    yield `<!--lit-part-->`;
    if (value === void 0 || value === null || value === A || value === w) ; else if (Array.isArray(value)) {
      for (const item of value) {
        yield* renderValue(item, renderInfo);
      }
    } else {
      yield (0, import_escape_html2.default)(String(value));
    }
  }
  yield `<!--/lit-part-->`;
}
    ...
    switch (op.type) {
      ...
      case "attribute-part":{
          ...
          if (committedValue !== w) {
            ...
            if (part.type === t3.PROPERTY) {
              yield* renderPropertyPart(instance, op, committedValue);
            } else if (part.type === t3.BOOLEAN_ATTRIBUTE) {
      ...
      case "custom-element-shadow":{
          const instance = getLast(renderInfo.customElementInstanceStack);
          if (instance !== void 0 && instance.renderShadow !== void 0) {
...
function* renderPropertyPart(instance, op, value) {
  ...
  if (reflectedName !== void 0) {
    yield `${reflectedName}="${(0, import_escape_html2.default)(String(value))}"`;
  }
}
...
function* renderAttributePart(instance, op, value) {
  if (value !== A) {
    if (instance !== void 0) {
      ...
      yield `${op.name}="${(0, import_escape_html2.default)(String(value ?? ""))}"`;
    }
  }
}
var getLast = (a4) => a4[a4.length - 1];

// package/lib/lit-element-renderer.js
var { attributeToProperty, changedProperties } = e4;
var LitElementRenderer = class extends ElementRenderer {
  constructor(tagName) {
    super(tagName);
  ...
  connectedCallback() {
    ...
    a.prototype.update.call(this.element);
  }
...
const { document: document$1 } = globalThis[domShimSymbol];
...
class HydrateMedia1 {
    ...
    keys(node) {
        return [
            node.getAttribute(this.mediaAttr)
        ];
    }
...
class Hydration {
    ...
    constructor(hydrationMethod, hydrationAttr, providedHydrators){
        ...
        this.hydratorMap = new Map(this.hydrators.filter((h)=>h.condition
        ).map((h)=>[
                h.condition,
                h
            ]
...
function createInstance(options) {
    ...
    function outdent(stringsOrOptions, ...values) {
        if (isTemplateStringsArray(stringsOrOptions)) {
            ...
            return createInstance(extend(extend({
...
const elementsBeforeBody = new Set([
    ...validHeadElements,
    'html',
    'head'
]);
...
function* serialize(node) {
    switch(node.nodeType){
        ...
        case 3:
            {
                if (isInsideScript(node)) yield node.data;
...
class ComponentPart {
    constructor(node1, state1){
        let start2 = state1.i;
        this.node = node1;
        this.document = node1.ownerDocument;
        this.start = start2;
        this.bindings = new Map();
        this.hasBindings = false;
        this.process(node1, state1);
        this.end = state1.i;
    }
    process(node, state) {
...
function* holeValue(state2) {
    yield {
        type: 'hole'
    };
    state2.i++;
}
function* multiInterpolation(str, state2) {
    let insertions = str.split(commentPlaceholder);
    let i = 0, len = insertions.length;
    do {
        if (i > 0) {
            yield* holeValue(state2);
        }
        yield htmlValue(insertions[i]);
    }while (++i < len)
}
function* walkFragment(frag, state2) {
    for (let node2 of frag.childNodes){
        yield* walk(node2, state2);
    }
}
function* walkElement(node2, state2) {
    let customElements = node2.ownerDocument.defaultView.customElements;
    if (customElements.get(node2.localName)) {
        yield {
            type: 'component',
            value: node2
        };
    ...
    yield htmlValue(`<${node2.localName}`);
    for (let { name: name2 , value  } of node2.attributes){
        if (value === '') {
            yield htmlValue(` ${name2}`);
        } else {
            yield htmlValue(` ${name2}="`);
            yield* multiInterpolation(escapeAttributeValue(value), state2);
            yield htmlValue('"');
        }
    }
    yield htmlValue(`>`);
    for (let child of node2.childNodes){
        yield* walk(child, state2);
    }
    if (!nonClosingElements.has(node2.localName)) {
        yield htmlValue(`</${node2.localName}>`);
    }
}
function* walk(entryNode, state2) {
    let node2 = entryNode;
    switch(node2.nodeType){
        case 1:
            {
                yield* walkElement(node2, state2);
                break;
            }
        case 3:
            {
                yield* multiInterpolation(node2.data, state2);
                break;
            }
        case 8:
            {
                if (node2.data === prefix) {
                    yield* holeValue(state2);
                } else {
                    yield htmlValue(`<!--${node2.data}-->`);
                }
                break;
            }
        case 11:
            {
                yield* walkFragment(node2, state2);
                break;
            }
    }
}
class Codegen {
    createTemplates(frag, doctype) {
        ...
        for (let { type , value  } of walk(frag, state2)){
            switch(type){
                case 'html':
                    {
                        buffer += value;
                ...
                case 'hole':
                    {
                        templates.push(new TextPart(buffer, state2.i, state2.i + 1));
                        buffer = '';
                        break;
                    }
                case 'component':
                    {
                        if (buffer) {
                            templates.push(new TextPart(buffer, state2.li, state2.i));
                            buffer = '';
                        }
                        templates.push(new ComponentPart(value, state2));
                        break;
                    }
            }
            state2.li = state2.i;
        ...
        if (buffer) {
            templates.push(new TextPart(buffer, state2.i + 1));
        }
...
class EndOfHead {
    ...
    visit(node) {
        ...
        let name2 = node.localName;
        if (node.localName === 'head') {
            this.head = node;
            return true;
        }
        if (!elementsBeforeBody.has(name2)) {
...
class Optimizer {
    ...
    optimize(frag) {
        ...
        let eoh = new EndOfHead(document1);
        let walker = document1.createTreeWalker(frag, 133, null, false);
        let currentNode = frag;
        while(currentNode){
            switch(currentNode.nodeType){
                case 1:
                    {
                        let name2 = currentNode.localName;
                        ...
                        if (customElements.get(name2)) {
                            ...
                            if (elements.has(name2)) {
                                hydrator.handle(eoh, currentNode, elements.get(name2));
                            }
                        }
                        break;
                    }
    ...
    inlinePolyfill() {
        return `const o=(new DOMParser).parseFromString('<p><template shadowroot="open"></template></p>',"text/html",{includeShadowRoots:!0}).querySelector("p");o&&o.shadowRoot||async function(){const{hydrateShadowRoots:o}=await import("${this.polyfillURL}");o(document.body)}()`;
    }
}
class Template {
    constructor(parts1){
...
class Compiler {
    ...
    compile(parts, values) {
        ...
        let raw1 = defaultOutdent(parts, ...replacedValues);
        let doctype = new Doctype(raw1);
        raw1 = doctype.remove();
        let div = document1.createElement('div');
        div.innerHTML = raw1;
        let frag = document1.createDocumentFragment();
...
function must(opts2, key) {
    if (!(key in opts2)) {
        throw new Error(`The option [${key}] is missing.`);
    }
    return Reflect.get(opts2, key);
}
class Ocean1 {
    #polyfilURL;
    constructor(opts2 = {
        ...
        this.polyfillURL = opts2.polyfillURL || null;
        this.plugins = opts2.plugins || [];
        this.hydrator = new Hydration(opts2.hydration, opts2.hydrationAttr, opts2.hydrators);
...
const WaferMixin = (superclass) => class Wafer extends superclass {
  static get template() {
    return "";
  }
  static get props() {
  ...
  _setFromProp(name, value) {
    if (!this._needsRehydrating) {
      ...
      if (reflect || !this._removeUnreflectedAttributes) {
        if (type === Boolean) {
          if ([null, false, void 0].includes(value)) {
            if (this.hasAttribute(attributeName)) {
              this.removeAttribute(attributeName);
            }
          } else {
...
const updateTargets = async (apply, el, { value, targets = [] }) => {
  for (const target of targets) {
    ...
    await apply(el, selectorVal, async (targetEl) => {
      ...
      if (attribute) {
        if ([null, false, void 0].includes(useValue)) {
    ...
    if (shadow) {
      if (!this.shadowRoot) {
        if (this._needsRehydrating) {
          ...
          this.attachShadow({ mode: shadow }).appendChild(stamp(this.constructor.template));
        }
      }
    }
...
class Header extends WaferClient {
  static get template() {
    return `
...
class MyElement$1 extends WaferClient {
  static get template() {
    return `
      <span id="count"></span>
...
customElements.define('wafer-el', MyElement$1);
...
const render = async () => {
  ...
  const { html, elements } = new Ocean1({
    document,
    polyfillURL: '/_static/dsd.js',
    hydrators: [new HydrateLoad1()],
  });
